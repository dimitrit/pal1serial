...
\begin{figure}[htbp]
  ...
  \scalebox{0.2}{
	...
	\draw[arrows={Circle[open,scale=6,line width=2] -Latex[scale=5]}](62.25,15) -- ++(-15.25,0);
	...
	\draw[arrows={Circle[open,scale=6,line width=2]-Latex[scale=5]}](50.5,35) -- ++(0,-26) --
			++(-67.5,0) -- ++(0,21);
	\draw[{Circle[open,scale=6,line width=2]}-{Circle[open,scale=6,line width=2]}](46,46.5) -- ++(16.25,0);
	...
	\draw[line width=1](62.25,46.5) -- ++(4,2) -- ++(0,-4) -- cycle;
	\draw[arrows={Latex[scale=5]-}](66.25,46.5) -- ++(4,0);

	\draw[line width=1](62.25,15) -- ++(4,2) -- ++(0,-4) -- cycle;
	\draw[arrows={Latex[scale=5]-}](66.25,15) -- ++(3.5,0);
